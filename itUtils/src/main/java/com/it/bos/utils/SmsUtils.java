...
public class SmsUtils {
    ...
    static final String accessKeyId = "LTAIe6CJwUhomCiM";
    static final String accessKeySecret = "peWZgChav9aVehb6j25TLw0badyIb2";
    ...
    public static SendSmsResponse sendSms(String telephone, String code)
        ...
        // 必填:短信签名-可在短信控制台中找到
        request.setSignName("七夜");
        // 必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_128520032");
